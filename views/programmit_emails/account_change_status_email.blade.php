...
<!-- BODY -->
<table class="body-wrap" ><td></td>
    <td class="container">

      <div class="content">
      <table><tbody><tr><td>
             <p><a href="https://apa-inter.com"><img src="https://apa-inter.com/resources/emails/apa-logo-black-org.png" width="100%" alt="APA" class="logo-top"></a></p><hr>
<br>
<div class="center">
  @if( $member->account_status >= 1 && $member->account_status <= 3 )
    <div class="alert alert-danger">
    @else
    <div class="alert alert-success">
  @endif
    Your Account Status has been set to "{{ $member->accountStatusName->name }}"
  </div>
</div>
...
<div align="center" style="margin:5px">
   @if( $member->account_status >= 1 && $member->account_status <= 3 )
          Your account has been locked for further notice. 
    @else
        Your Account has been Approved from the administartion.<br>
        please login to your account from the login page <a href="https://apa-inter.com/login"> Login Page </a>
    @endif

    @if( $member->account_status_message && !empty($member->account_status_message) )
      <p>
          Administration Message
          <br>{!! $member->account_status_message !!}
      </p>
    @endif
</div>
</blockquote>
</div></td></tr></tbody></table></div></td></table>
<!-- <p>Note: Note this message has been also saved in the CMS for apa-inter.</p>
<sub>Thank You</sub> -->

  @include('emails.partials.footer_signature')                  
